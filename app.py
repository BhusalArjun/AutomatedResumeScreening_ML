...
GOOGLE_CLIENT_ID = "605723984194-qrihc59u2hn7n5tuk0aecmmoqo8d950r.apps.googleusercontent.com"
...
app.config['MONGO_URI']= 'mongodb+srv://admin:admin@cluster0.iskk9.mongodb.net/AutomatedResumeScreening'
...
def HR():
    if request.method == 'POST':
        ...
        if response == "hr1@gmail.com":
            
            return render_template("CompanyDashboard.html")
        elif response == "hr2@gmail.com":
            return render_template("CompanyDashboard.html")
...
def viewdetails():      
    ...
    return jsonify({'name':name,'linkedin_link':linkedin_link,'skills':skills,'certificate':certificate,'resume_data': resume_data})
